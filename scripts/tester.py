...
def build_model(is_cuda):
    net = cv2.dnn.readNet('../../yolov5/runs/train/exp2/weights/best.onnx')
    if is_cuda:
...
while True:
    ...
    if capture.color is None:
        continue
    frame = convert_to_bgra_if_required(playback.configuration["color_format"], capture.color)
    if frame is None:
        print("End of stream")
        break
